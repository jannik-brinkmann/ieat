...
class WordEmbeddingAssociationTest:
    ...
    def run(self, randomized=False, **kwargs):
        ...
        logging.info("Computing pval...")
        p = self.p(**kwargs)
        logging.info("pval: %g", p)

        logging.info("computing effect size...")
        e = self.effect_size()
        logging.info("esize: %g", e)
    ...
    def p(self, n_samples=10000, parametric=False):
        ...
        if parametric:
            ...
            logging.info('Drawing {} samples'.format(n_samples))
            samples = []
            ...
            if num_partitions > n_samples:
                ...
                total_true += 1
                total += 1
                logging.info('Drawing {} samples (and biasing by 1)'.format(n_samples - total))
